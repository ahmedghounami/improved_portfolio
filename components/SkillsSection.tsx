...
export default function SkillsSection() {
    const skills = [
        ...
        { name: "Node.js/Express", level: 90, icon: <Server className="w-5 h-5" />, color: "from-blue-500 to-blue-700" },
        { name: "Database Design", level: 85, icon: <Database className="w-5 h-5" />, color: "from-blue-300 to-blue-500" },
        { name: "C/C++", level: 88, icon: <Code className="w-5 h-5" />, color: "from-blue-600 to-blue-800" },
        { name: "Full-Stack Dev", level: 92, icon: <Globe className="w-5 h-5" />, color: "from-blue-400 to-blue-700" },
    ]
                ...
                >
                    ...
                    <div className="max-w-4xl mx-auto">
                        {skills.map((skill, index) => (
                            ...
                            >
                                <div className="bg-black/30 backdrop-blur-xl border border-blue-500/20 rounded-2xl p-6 hover:border-blue-400/40 transition-all duration-300">
